...
# Path of this script: /opt/my_gits/HICCE/hicce-project/hicce_w_header/vitis/hicce_w_header_system/_ide/scripts/debugger_hicce_w_header-default_(1).tcl
# 
# 
# Usage with xsct:
# To debug using xsct, launch xsct and run below command
# source /opt/my_gits/HICCE/hicce-project/hicce_w_header/vitis/hicce_w_header_system/_ide/scripts/debugger_hicce_w_header-default_(1).tcl
# 
