...
\
  ...
  connect_bd_net -net DBG_COUNT_CD [get_bd_pins CombIntan_w_header_0/DBG_COUNT_CD] [get_bd_pins system_ila_0/probe21]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets DBG_COUNT_CD]
  connect_bd_net -net DBG_MAX_COUNT_AB [get_bd_pins CombIntan_w_header_0/DBG_MAX_COUNT_AB] [get_bd_pins system_ila_0/probe22]
